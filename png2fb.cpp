...
int main(int argc, char* argv[]){
	...
	int gd_imagewidth=gdImageSX(gd_image); //fill gd width variable
	int gd_imageheight=gdImageSY(gd_image); //fill gd height variable
	
	
	
	//while(true){
	//for(int rendloop=0;rendloop<100;rendloop++){
	int fb_position=0; //framebuffer seek position
