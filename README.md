...
- 0.1g : Battery percentage prediction (testing stage), because battery percentage can "bounce" easily due to spike when reading voltage, percentage precision in set to 10% increment only.
